...
- Status: Accepted (pilot). NOT yet wired into the Snakefile (classify rule still a stub) — promotion to reusable rules/scripts is the next engineering step; scaling to all 10 GBI is the next science step.
